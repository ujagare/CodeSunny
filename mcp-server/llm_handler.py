...
openai_client = OpenAI(api_key=openai_key) if openai_key and openai_key != "your_openai_api_key_here" else None
...
# Priority: Groq > Gemini > MinMax > OpenAI
...
def chat_with_llm(message: str, session: dict) -> dict:
    ...
    system = (
        "You are CodeSunny's AI Business Consultant.\n"
        "\n"
        "SERVICES: Web Development, E-commerce, UI/UX, SEO, Digital Marketing, AI Solutions\n"
        "\n"
        "YOUR ROLE:\n"
        "- Answer questions about services\n"
        "- Qualify leads naturally\n"
        "- Guide toward CTAs (quote, meeting, audit)\n"
