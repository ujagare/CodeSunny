    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <animate
            attributeName="x1"
            values={`${gradientCoordinates.x1[0]};${gradientCoordinates.x1[1]};${gradientCoordinates.x1[0]}`}
            dur={`${duration}s`}
            begin={`${delay}s`}
          ...
          <animate
            attributeName="x2"
            values={`${gradientCoordinates.x2[0]};${gradientCoordinates.x2[1]};${gradientCoordinates.x2[0]}`}
            dur={`${duration}s`}
            begin={`${delay}s`}
            repeatCount="indefinite"
          />
          <animate
            attributeName="y1"
            values={`${gradientCoordinates.y1[0]};${gradientCoordinates.y1[1]};${gradientCoordinates.y1[0]}`}
            dur={`${duration}s`}
            begin={`${delay}s`}
            repeatCount="indefinite"
          />
          <animate
            attributeName="y2"
            values={`${gradientCoordinates.y2[0]};${gradientCoordinates.y2[1]};${gradientCoordinates.y2[0]}`}
            dur={`${duration}s`}
            begin={`${delay}s`}
            repeatCount="indefinite"
          />
