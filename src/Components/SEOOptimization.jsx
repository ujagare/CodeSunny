...
const SEOOptimization = () => {
  ...
  return (
    <>
      <MetaTags
        title="SEO Optimization Services - CodeSunny"
        description="Professional SEO services to boost your search rankings and drive organic traffic. Keyword research, on-page optimization, link building, and technical SEO."
        keywords="SEO, search engine optimization, keyword research, link building, technical SEO, organic traffic, Google rankings"
        url="https://codesunny.com/services/seo-optimization"
      />
          ...
          >
            <article className="flex flex-col items-center text-center max-w-4xl mx-auto">
              <div className="mb-12">
                <h1
                  id="hero-heading"
                  className="text-4xl sm:text-5xl md:text-8xl lg:text-9xl font-light tracking-tighter mb-6 leading-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-emerald-400"
                >
