...
export function MarqueeTestimonials({ 
  ...
  return (
    <section className={`w-full text-white py-12 sm:py-24 md:py-32 ${className}`}>
      <div className="flex flex-col items-center gap-4 text-center sm:gap-16">
        ...
        <div className="relative flex w-full flex-col items-center justify-center overflow-hidden">
          ...
          <div className="group flex overflow-hidden p-2 gap-4 flex-row mt-6" style={{ '--duration': '200s', '--gap': '1rem' }}>
