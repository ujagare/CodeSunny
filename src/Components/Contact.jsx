  ...
  return (
    <div className="w-full min-h-screen relative overflow-hidden font-[Inter] text-gray-100 selection:bg-indigo-600/50">
      ...
      <main className="flex-1 flex flex-col items-center justify-center pt-24 pb-16 px-6">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-center gap-16 w-full mb-32">
          ...
          <section className="w-full lg:max-w-md space-y-6">
            ...
            <p className="text-lg text-neutral-300 font-light tracking-tight">
              Have a project in mind? We'd love to hear from you. Reach out to discuss your ideas, requirements, and how we can help transform your vision into reality.
            </p>
          ...
          <div className="relative flex flex-col items-center space-y-8 perspective-1000 hidden lg:flex">
            ...
            >
              <header className="p-6">
                <div className="flex gap-3 items-start">
                  ...
                  <h2 className="text-sm leading-6 font-light tracking-tight text-white">Let's Connect</h2>
                </div>
              </header>
              ...
              <div className="p-6 space-y-6">
                <div>
                  <h3 className="text-xs text-neutral-400 font-light tracking-tight">RESPONSE TIME</h3>
                ...
                <div className="flex">
                  <div className="w-24">
                    <h3 className="text-xs text-neutral-400 font-light tracking-tight">CHANNELS</h3>
                  </div>
                  <ul className="flex flex-wrap gap-2">
                    <li className="px-2.5 py-0.5 rounded-md text-xs bg-indigo-900/40 text-indigo-200 font-light tracking-tight">Email</li>
                    <li className="px-2.5 py-0.5 rounded-md text-xs bg-pink-900/40 text-pink-200 font-light tracking-tight">Phone</li>
                    <li className="px-2.5 py-0.5 rounded-md text-xs bg-green-900/40 text-green-200 font-light tracking-tight">Chat</li>
                  </ul>
                </div>

                <div className="flex">
                  <div className="w-24">
                    <h3 className="text-xs text-neutral-400 font-light tracking-tight">AVAILABILITY</h3>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-emerald-400"></span>
                    <span className="text-sm font-light tracking-tight">Always Open</span>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section 
              ...
              style={{ transform: 'rotateY(20deg) rotateZ(-15deg) translateZ(50px)' }}
            >
              <div className="flex items-center justify-between border-b border-white/10 px-6 py-3 bg-white/5 backdrop-blur-sm">
                <div className="flex items-center gap-2">
                  <span className="text-sm font-light tracking-tight text-white">Contact Info</span>
              ...
              <div className="p-6 space-y-4">
                <div>
                  <h3 className="text-xs text-neutral-400 font-light tracking-tight mb-2">EMAIL</h3>
                  <p className="text-sm text-neutral-200 font-light tracking-tight">hello@codesunny.com</p>
                </div>
                <div>
                  <h3 className="text-xs text-neutral-400 font-light tracking-tight mb-2">PHONE</h3>
                  <p className="text-sm text-neutral-200 font-light tracking-tight">+1 (555) 123-4567</p>
                </div>
        ...
        <section className="md:pt-40 bg-center z-[70] bg-cover pt-40 pb-40 relative w-full" style={{maskImage: 'linear-gradient(90deg, transparent, black 55%, black 60%, transparent)', WebkitMaskImage: 'linear-gradient(90deg, transparent, black 55%, black 60%, transparent)'}} id="contact">
          ...
          <div className="max-w-4xl mx-auto px-6 flex flex-col items-center justify-center">
            <div className="text-center w-full">
              ...
              <p className="mt-4 text-neutral-400 text-lg max-w-2xl mx-auto animate-in">
                Whether you need help with web development, design, or digital marketing, we're here to help bring your vision to life.
              </p>
            </div>
