...
const CloudSolutions = () => {
  ...
  return (
    <>
      <MetaTags
        title="Cloud Solutions & Hosting - CodeSunny"
        description="Reliable cloud hosting and deployment services with scalable infrastructure. AWS, Google Cloud, Azure integration, server management, and 24/7 support."
        keywords="cloud hosting, cloud solutions, AWS, Google Cloud, Azure, server management, deployment, infrastructure"
        url="https://codesunny.com/services/cloud-solutions"
      />
