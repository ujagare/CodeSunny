...
const EcommerceSolutions = () => {
  ...
  return (
    <>
      <MetaTags
        title="E-commerce Solutions - CodeSunny"
        description="Complete e-commerce development services with secure payments, inventory management, and seamless shopping experiences. Build your online store today."
        keywords="e-commerce, online store, shopping cart, payment gateway, inventory management, online sales"
        url="https://codesunny.com/services/ecommerce-solutions"
      />
