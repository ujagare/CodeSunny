...
const BrandVideo = () => {
  return (
    <section 
      className="w-full h-auto bg-[#EFEFEF] overflow-hidden"
      aria-label="Brand Showreel"
    >
      <div className="container mx-auto px-[5vw]">
        {/* The video container mimics the large grey rectangle seen in the screenshots below the hero text */}
        <div className="relative w-full aspect-video md:mt-[100px] mb-[120px] bg-[#D1D1D1]">
          ...
          {/* Subtle overlay for light integration as per HLD */}
          <div 
