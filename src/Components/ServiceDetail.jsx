  ...
  return (
    <div className="w-full min-h-screen relative overflow-hidden font-[Manrope] text-white selection:bg-blue-500/30">
      ...
      <main className="flex-1 flex flex-col items-center pt-24 pb-16 px-6">
        <section className="container mx-auto px-4 sm:px-6 py-12 md:py-24 lg:py-32 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="max-w-3xl">
              <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-light tracking-tighter mb-4 sm:mb-6 leading-tight">
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-cyan-400">
                  {title}
                </span>{" "}
                {subtitle}
              </h1>
              <p className="text-gray-300 text-xl sm:text-2xl md:text-3xl mb-6 sm:mb-8 max-w-lg font-extralight tracking-wide">
                {description}
              </p>
            ...
            <div className="hidden lg:block relative">
              <div className="relative w-full h-[500px]">
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96">
                  ...
                  <div
                    className="absolute inset-16 rounded-full border-2 border-purple-500/20"
                ...
                {floatingIcons.map((item, index) => (
                  ...
                  >
                    <div
                      className={`${item.size} rounded-2xl bg-gradient-to-br ${item.gradient} backdrop-blur-sm border ${item.border} flex items-center justify-center shadow-lg hover:scale-110 transition-transform`}
                    >
        ...
        <div
          className="h-px w-full bg-gradient-to-r from-transparent via-gray-800 to-transparent my-16"
          role="separator"
        ></div>
